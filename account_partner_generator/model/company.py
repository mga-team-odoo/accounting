...
class res_company(orm.Model):
    ...
    _columns = {
        ...
        # 'prefix_acc_customer': fields.char(
        #     'Prefix for customer account', size=12,
        #     help='Choose prefix for customer account'),
        # 'prefix_acc_supplier': fields.char(
        #     'Prefix for supplier account', size=12,
        #     help='Choose prefix for supplier account'),
